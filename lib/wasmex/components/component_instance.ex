defmodule Wasmex.Components.Instance do
  ...
  def new(store_or_caller, component, imports, server_pid) do
    %{resource: store_or_caller_resource} = store_or_caller
    %{resource: component_resource} = component

    case Wasmex.Native.component_instance_new(store_or_caller_resource, component_resource, imports, server_pid) do
      {:error, err} -> {:error, err}
