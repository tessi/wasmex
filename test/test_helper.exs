defmodule TestHelper do
  ...
  def precompile_wasm_files do
    ...
    {_, 0} = System.cmd("cargo", ["build"], cd: @wasm_import_test_source_dir, stderr_to_stdout: true)
    {_, 0} = System.cmd("cargo", ["build"], cd: @wasm_link_import_test_source_dir, stderr_to_stdout: true)
    ...
    {_, 0} =
      System.cmd("cargo", ["component", "build"], cd: @component_type_conversions_source_dir, stderr_to_stdout: true)

    {_, 0} =
      System.cmd("cargo", ["component", "build"], cd: @component_exported_interface_source_dir, stderr_to_stdout: true)
  end
